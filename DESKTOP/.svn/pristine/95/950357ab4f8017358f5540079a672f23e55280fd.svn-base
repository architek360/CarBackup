$(document).ready(function() {
    ...
        $('#addressform_firstName2').val($('input[name="firstName2"]').val());
        $('#fn_country').val($('input[name="country"]').val());
      };
    ...
    $(".edit_add").click(function() {
        ...
        var $selectedAddress = $('#address-select select option:selected'),
            isPoBox = $selectedAddress.data('pobox'),
            poBoxNumber = "";
    ...
    if (cartier.countryHandler.isUS) {
        ...
        if (isPoBox) {
            ...
            $("input[name='addressform_address2']").prop("disabled", true);
            $("input[name='addressform_address12']").prop("disabled", false);
            poBoxNumber = $selectedAddress.data("poboxnumber");
    ...
    $(".delete_add").click(function() {
        ...
        $('body').data('plugin_confirmBox').popupInitialize({
                ...
                'buttons': {
                    ...
                    'no': {
                        ...
                        'class': 'cta-button cta-button__inner cta--red js-nobutton'
        ...
        $('.popup-close-button').on('click',function (argument) {
            $('.js-nobutton').trigger('click');
        })
    });
