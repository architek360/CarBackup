	...
	cartier.location.filter = function(element, options, ns, win, $, undefined) {
        ...
        */
			ns._bindEventsFilter = function() {
				...
				$('.scrollContainer ul li').on('click', function(e) {

					_handleCheckBoxListClick(e, this);
				});
                $('.scrollContainer ul li>span').on('click', function(e) {
                    e.stopPropagation(); 
          ...
          @param : none
        */
			var _hideScrollContainer = function() {
        ...
        */
            ...
            _handleCheckBoxListClick = function(e) {
        ...
        */
          ...
          @param : null
        */
			var _updateFilterSidRelation = function() {
				var hidden = [];
				var visibles = [];
        ...
        */
			_initialize = function() {
				...
				if($('.tab-entrust-boutique').length === 0){
					ns._initDropdown();
