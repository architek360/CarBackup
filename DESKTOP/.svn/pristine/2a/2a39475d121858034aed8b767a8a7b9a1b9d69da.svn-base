...
*/
    ...
    */
	...
	productlist.init = function() {
		...
		if (typeof _objPropertiesPth.collectionJson !== "undefined" && cartier.properties.paths.collectionJson !== null) {
			_cacheObjects();
		...
		if ($('.js-search-form').length) {            
			var totalCountOnSearch = 0;
			$('.js-search-count').each(function(i, item) {
				totalCountOnSearch += $(item).data('count');
			});            
			$('.js-search-count-display').html(totalCountOnSearch);        
		}
	};
