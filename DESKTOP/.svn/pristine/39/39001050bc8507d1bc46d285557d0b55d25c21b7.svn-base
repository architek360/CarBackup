    ...
    properties.init = function() {
        cartier.properties = {
            paths: {
                ...
                askaappointment: '../json/ask_for_apointment.json',//'/bin/cartier/appointmentStores.json',
            ...
            messages: {
                ...
                sbRemovingProduct: "Removing a product from your cart. Please wait.",
                sbAddInfo: "Adding customization to your product. Please wait.",
                sbRemovingInfo: "Removing customization to your product. Please wait.",
                sbproductQuantChange: "Changing the number of products on your cart. Please wait.",
                sbproductSizeChange: "Changing the variant of the product. Please wait.",
                sbquantChangeForinfo: "You have changed the qunatity of a customized product.",
                wishlistReordered: "Wishlist is reordered",
                engravingErrorMessage:"Fill atleast one line",
                ecsBillingAddressAlternateText : 'Billing Address',
                noCollectionAvailable: "There are no collections on this page",
