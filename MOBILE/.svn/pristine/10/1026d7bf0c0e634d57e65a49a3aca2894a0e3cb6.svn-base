 ...
 * USAGE :
 *
 * This is a plugin for calling a popup after confirmation of a particular event. we can use this function :
        ...
        */
        popupInitialize: function(params, confirmHide) {
            ...
            $.each(params.buttons, function(name, obj) {
                ...
                buttonHTML += '<button href=" ' + obj['href'] + '" class=" ' + obj['class'] + '"> <span class="cta-button__input">' + obj.buttonName + '</span></button>';
            ...
            var markup = [
                ...
                buttonHTML,
                '</div><p><a href='+params.src1+' class='+params.linkClasses+'>', params.anchormessage1, '</a></p></div></div>'
            ].join('');
