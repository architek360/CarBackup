...
(function(win, $, billing, undefined) {
     ...
     */
		_boutiqueListOnLoadOnShipping = function() {
			...
			$('.boutique-address').html($(".js-boutique-list-container > select").find('option:first-child').data("baddress"));
			$('.boutique-contact').html($(".js-boutique-list-container > select").find('option:first-child').data("bcontact"));
