	...
	_cache = {},
	    ...
	    */
		_cloneShoppingBag = function() {
			...
			_updatedShoppingBag(_objPropertiesPth.getCart, "sw=https&currentPage=" + $("#currentPage").val());
		},
	    ...
	    */
		...
		_fillProduct = function(data, isRemoved) {
			...
			if (isRemoved) {
				...
				_product.find('.product-detail').wrap("<a href=" + data.productPagePath + ".html></a>");
